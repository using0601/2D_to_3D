...
# Intrinsic
fs = cv2.FileStorage("GT2Comap/intri.yml", cv2.FILE_STORAGE_WRITE)
intri = read_intrinsics_binary("GT2Comap/cameras.bin")
...
# Extrinsic
fs = cv2.FileStorage("GT2Comap/extri.yml", cv2.FILE_STORAGE_WRITE)
extri = read_extrinsics_binary("GT2Comap/images.bin")
